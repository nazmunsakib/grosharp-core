...
<section <?php echo get_block_wrapper_attributes( array( 'class' => 'grosharp-block grosharp-post-hero bg-white pt-24 md:pt-[clamp(5rem,10vw,8rem)]' ) ); ?> style="padding-bottom:2rem;">
	<div class="gs-container">
		...
		<div class="max-w-[860px]">
			...
			<?php if ( $brief ) : ?>
				<p class="ph-sub opacity-0" data-ph-sub>
			...
			<?php if ( ! $brief_meta_key ) : ?>
				<div class="flex flex-wrap items-center gap-x-5 gap-y-2" data-ph-sub>
					<?php if ( $cat_name ) : ?>
			...
			<?php if ( ! empty( $tech_tags ) ) : ?>
				<div class="flex flex-wrap gap-2" data-gs-ph-stack>
					<?php foreach ( $tech_tags as $tag ) : ?>
						<span class="inline-flex items-center rounded-full border border-black/15 px-3.5 py-1 font-body text-[0.8125rem] font-medium text-brand-muted">
