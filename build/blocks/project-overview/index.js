(function (blocks, element, blockEditor, i18n) {
	...
	blocks.registerBlockType('grosharp/project-overview', {
		edit: function () {
			var blockProps = useBlockProps({ className: 'grosharp-project-overview-editor' });
			return el(
				'div',
				blockProps,
				el(
					...
					el('p', { style: { margin: 0, color: '#777', fontSize: '13px' } },
						'Renders: Client · Year · Services · Live Site. Edit via ACF fields below.'
					)
				)
			);
		},
